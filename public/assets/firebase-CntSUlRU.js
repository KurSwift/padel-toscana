 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const wf=1e3,Af=2,Rf=14400*1e3,Pf=.5;function fE(n,e=wf,t=Af){const r=e*Math.pow(t,n),i=Math.round(Pf*r*(Math.random()-.5)*2);return Math.min(Rf,r+i)}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function RE(n){n=ke(n,ee);const e=ke(n.firestore,it);return Gv(Ir(e),n._key).then((t=>hd(e,n,t)))}Bt._jsonSchemaVersion="firestore/querySnapshot/1.0",Bt._jsonSchema={type:ue("string",Bt._jsonSchemaVersion),bundleSource:ue("string","QuerySnapshot"),bundleName:ue("string"),bundle:ue("string")};class Qi extends ld{constructor(e){super(),this.firestore=e}convertBytes(e){return new De(e)}convertReference(e){const t=this.convertDocumentKey(e,this.firestore._databaseId);return new ee(this.firestore,null,t)}}function PE(n){n=ke(n,Kt);const e=ke(n.firestore,it),t=Ir(e),r=new Qi(e);return cd(n._query),Kv(t,n._query).then((i=>new Bt(e,r,n,i)))}function SE(n,e,t){n=ke(n,ee);const r=ke(n.firestore,it),i=oa(n.converter,e,t);return aa(r,[Zo(Ar(r),"setDoc",n._key,i,n.converter!==null,t).toMutation(n._key,we.none())])}function CE(n,e,t,...r){n=ke(n,ee);const i=ke(n.firestore,it),s=Ar(i);let a;return a=typeof(e=se(e))=="string"||e instanceof wr?id(s,"updateDoc",n._key,e,t,r):rd(s,"updateDoc",n._key,e),aa(i,[a.toMutation(n._key,we.exists(!0))])}function bE(n,e){const t=ke(n.firestore,it),r=Jv(n),i=oa(n.converter,e);return aa(t,[Zo(Ar(n.firestore),"addDoc",r._key,i,n.converter!==null,{}).toMutation(r._key,we.exists(!1))]).then((()=>r))}function kE(n,...e){var t,r,i;n=se(n);let s={includeMetadataChanges:!1,source:"default"},a=0;typeof e[a]!="object"||Uu(e[a])||(s=e[a++]);const u={includeMetadataChanges:s.includeMetadataChanges,source:s.source};if(Uu(e[a])){const g=e[a];e[a]=(t=g.next)===null||t===void 0?void 0:t.bind(g),e[a+1]=(r=g.error)===null||r===void 0?void 0:r.bind(g),e[a+2]=(i=g.complete)===null||i===void 0?void 0:i.bind(g)}let l,d,p;if(n instanceof ee)d=ke(n.firestore,it),p=Li(n._key.path),l={next:g=>{e[a]&&e[a](hd(d,n,g))},error:e[a+1],complete:e[a+2]};else{const g=ke(n,Kt);d=ke(g.firestore,it),p=g._query;const v=new Qi(d);l={next:S=>{e[a]&&e[a](new Bt(d,v,g,S))},error:e[a+1],complete:e[a+2]},cd(n._query)}return(function(v,S,b,M){const V=new Jo(M),q=new Go(S,V,b);return v.asyncQueue.enqueueAndForget((async()=>zo(await Pi(v),q))),()=>{V.Ou(),v.asyncQueue.enqueueAndForget((async()=>Ho(await Pi(v),q)))}})(Ir(d),p,u,l)}function aa(n,e){return(function(r,i){const s=new qe;return r.asyncQueue.enqueueAndForget((async()=>Dv(await Hv(r),i,s))),s.promise})(Ir(n),e)}function hd(n,e,t){const r=t.docs.get(e._key),i=new Qi(n);return new wt(n,i,e._key,r,new rn(t.hasPendingWrites,t.fromCache),e.converter)}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */vt(lE,hE,"app");export{yE as A,_E as B,qt as C,nf as D,lr as E,st as F,ft as G,PE as H,TE as I,RE as J,VE as K,so as L,bE as M,CE as N,DE as O,wE as P,AE as Q,gE as R,yn as S,SE as T,Y as U,un as _,Le as a,ao as b,tf as c,Yu as d,rf as e,pf as f,se as g,$u as h,gn as i,Xd as j,fE as k,lf as l,dE as m,jt as n,$f as o,Ku as p,Rp as q,vt as r,vE as s,IE as t,Qu as u,mf as v,pE as w,kE as x,Jv as y,mE as z};
